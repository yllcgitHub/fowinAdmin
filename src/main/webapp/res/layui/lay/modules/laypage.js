...
layui.define(function(exports){
  ...
  Page.prototype.view = function(){
    ...
    if(conf.pages <= 1){
      return '<div class="layui-box layui-laypage layui-laypage-default" id="layui-laypage-0"><span class="layui-laypage-next" >上一页</span><span class="layui-laypage-curr"><em class="layui-laypage-em"></em><em>1</em></span><span  class="layui-laypage-next" >下一页</span></div>';
    }
  ...
  Page.prototype.render = function(load){
    ...
    var view = that.view();
    view=view+'<span>  有'+conf.total+'条记录</span>'; 
    view=view+'<span>  共 '+conf.pages+'页</span>';
    if(type === 2){
